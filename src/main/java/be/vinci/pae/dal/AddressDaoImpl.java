...
public class AddressDaoImpl implements AddressDao {
    ...
    @Override
    public AddressDTO getAddresse(int id) {
    ...
    private AddressDTO getAdressFromDatabase(PreparedStatement query) throws SQLException {
        ...
        address.setId_address(resultSetAdress.getInt(1));
        address.setStreet(resultSetAdress.getString(2));
        address.setBuilding_number(resultSetAdress.getInt(3));
        ...
        address.setUnit_number(resultSetAdress.getInt(7));
